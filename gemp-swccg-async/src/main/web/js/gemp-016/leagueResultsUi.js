var LeagueResultsUI = Class.extend({
    ...
    createStandingsTable:function (standings) {
        ...
        standingsTable.append("<tr><th>Standing</th><th>Player</th><th>Points</th><th>Games played</th><th>Opp. Win %</th><th>W</th><th>L</th><th></th><th>Standing</th><th>Player</th><th>Points</th><th>Games played</th><th>Opp. Win %</th><th>W</th><th>L</th></tr>");
        ...
        for (var k = 0; k < secondColumnBaseIndex; k++) {
            ...
            standingsTable.append("<tr><td>" + currentStanding + "</td><td>" + player + "</td><td>" + points + "</td><td>" + gamesPlayed + "</td><td>" + opponentWinPerc + "</td><td>" + ((points-gamesPlayed)/2) + "</td><td>" + (gamesPlayed-(points-gamesPlayed)/2) + "</td></tr>");
        }
        ...
        for (var k = secondColumnBaseIndex; k < standings.length; k++) {
            ...
            $("tr:eq(" + (k - secondColumnBaseIndex + 1) + ")", standingsTable).append("<td></td><td>" + currentStanding + "</td><td>" + player + "</td><td>" + points + "</td><td>" + gamesPlayed + "</td><td>" + opponentWinPerc + "</td><td>" + ((points-gamesPlayed)/2) + "</td><td>" + (gamesPlayed-(points-gamesPlayed)/2) + "</td>");
        }
