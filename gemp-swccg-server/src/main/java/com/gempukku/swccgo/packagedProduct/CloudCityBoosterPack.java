...
/**
 * Defines a Cloud City booster pack.
 */
public class CloudCityBoosterPack extends BasePackagedCardProduct {
    private Random _random = new Random();
    private SetRarity _setRarity;

    /**
     * Creates a Cloud City booster pack.
     * @param library the blueprint library
     */
    public CloudCityBoosterPack(SwccgCardBlueprintLibrary library) {
        super(library);
        RarityReader rarityReader = new RarityReader();
        _setRarity = rarityReader.getSetRarity(String.valueOf(ExpansionSet.CLOUD_CITY.getSetNumber()));
    }
    ...
    public String getProductName() {
        return ProductName.CLOUD_CITY_BOOSTER_PACK;
    }
    ...
    public float getProductPrice() {
        return ProductPrice.CLOUD_CITY_BOOSTER_PACK;
    }
