...
/**
 * Defines a Special Edition booster pack.
 */
public class SpecialEditionBoosterPack extends BasePackagedCardProduct {
    private Random _random = new Random();
    private SetRarity _setRarity;

    /**
     * Creates a Special Edition booster pack.
     * @param library the blueprint library
     */
    public SpecialEditionBoosterPack(SwccgCardBlueprintLibrary library) {
        super(library);
        RarityReader rarityReader = new RarityReader();
        _setRarity = rarityReader.getSetRarity(String.valueOf(ExpansionSet.SPECIAL_EDITION.getSetNumber()));
    }
    ...
    public String getProductName() {
        return ProductName.SPECIAL_EDITION_BOOSTER_PACK;
    }
    ...
    public float getProductPrice() {
        return ProductPrice.SPECIAL_EDITION_BOOSTER_PACK;
    }
