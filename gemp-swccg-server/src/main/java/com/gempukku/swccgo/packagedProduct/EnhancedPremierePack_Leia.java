...
/**
 * Defines an Enhanced Premiere pack (Leia With Blaster Rifle).
 */
public class EnhancedPremierePack_Leia extends BasePackagedCardProduct {
    private List<String> _premiumCards = new ArrayList<String>();

    /**
     * Creates an Enhanced Premiere pack (Leia With Blaster Rifle).
     * @param library the blueprint library
     */
    public EnhancedPremierePack_Leia(SwccgCardBlueprintLibrary library) {
        super(library);
        _premiumCards.add("108_2");
    ...
    public String getProductName() {
        return ProductName.ENHANCED_PREMIERE_PACK_LEIA;
    }
