...
/**
 * An effect to draw the top card into hand from Used Pile.
 */
public class DrawCardIntoHandFromUsedPileEffect extends DrawCardsIntoHandFromUsedPileEffect {

    /**
     * Creates an effect that causes the player to draw the top card into hand from Used Pile.
     * @param action the action performing this effect
     * @param playerId the player
     */
    public DrawCardIntoHandFromUsedPileEffect(Action action, String playerId) {
