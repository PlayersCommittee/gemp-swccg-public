...
/**
 * A modifier to total destiny for a specified draw destiny.
 */
public class TotalDestinyModifier extends AbstractModifier {
    private int _drawDestinyStateId;
    private Evaluator _evaluator;

    /**
     * Creates a modifier to total destiny for a specified draw destiny.
     * @param source the source of the modifier
     * @param drawDestinyStateId the id of the draw destiny state for the draw destiny to affect
     * @param modifierAmount the amount of the modifier
     */
    public TotalDestinyModifier(PhysicalCard source, int drawDestinyStateId, float modifierAmount) {
     ...
     */
    public TotalDestinyModifier(PhysicalCard source, int drawDestinyStateId, Evaluator evaluator) {
        this(source, drawDestinyStateId, null, evaluator);
    }
     ...
     * @param modifierAmount the amount of the modifier
     */
    public TotalDestinyModifier(PhysicalCard source, int drawDestinyStateId, Condition condition, float modifierAmount) {
     ...
     * @param evaluator the evaluator that calculates the amount of the modifier
     */
    public TotalDestinyModifier(PhysicalCard source, int drawDestinyStateId, Condition condition, Evaluator evaluator) {
        super(source, null, null, condition, ModifierType.TOTAL_DESTINY, false);
