...
/**
 * An effect to draw the top card into hand from Lost Pile.
 */
public class DrawCardIntoHandFromLostPileEffect extends DrawCardsIntoHandFromLostPileEffect {

    /**
     * Creates an effect that causes the player to draw the top card into hand from Lost Pile.
     * @param action the action performing this effect
     * @param playerId the player
     */
    public DrawCardIntoHandFromLostPileEffect(Action action, String playerId) {
