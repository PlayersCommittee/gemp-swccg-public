...
/**
 * An effect to place the top card of a card pile on top of another card pile.
 */
class PlaceTopCardFromCardPileOnTopOfCardPileEffect extends AbstractSuccessfulEffect {
    private String _cardPileOwner;
    private Zone _fromPile;
    private Zone _toPile;

    /**
     * Creates an effect to place the top card of a card pile on top of another card pile.
     ...
     */
    protected PlaceTopCardFromCardPileOnTopOfCardPileEffect(Action action, String cardPileOwner, Zone fromPile, Zone toPile) {
        super(action);
    ...
    protected void doPlayEffect(SwccgGame game) {
        ...
        gameState.sendMessage(_action.getPerformingPlayer() + " places " + cardInfo + " from the top of " + playerNameForMsg + _fromPile.getHumanReadable() + " to the top of " + playerNameForMsg + _toPile.getHumanReadable());
