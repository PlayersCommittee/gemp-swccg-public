...
/**
 * An effect to choose a combination of cards from hand and/or a specified pile.
 */
abstract class ChooseCardCombinationFromHandAndOrCardPileEffect extends AbstractSubActionEffect {
    ...
    /**
     * Creates an effect that causes the player to choose a combination of cards from hand and/or a specified pile.
    ...
    public String getChoiceText(SwccgGame game, Collection<PhysicalCard> cardsSelected) {
        return "Choose cards from hand and/or " + _cardPile.getHumanReadable();
    }
