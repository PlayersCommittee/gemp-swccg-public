...
/**
 * An effect to draw the bottom card into hand from Used Pile.
 */
public class DrawCardIntoHandFromBottomOfUsedPileEffect extends DrawCardsIntoHandFromBottomOfUsedPileEffect {

    /**
     * Creates an effect that causes the player to draw the bottom card into hand from Used Pile.
     * @param action the action performing this effect
     * @param playerId the player
     */
    public DrawCardIntoHandFromBottomOfUsedPileEffect(Action action, String playerId) {
