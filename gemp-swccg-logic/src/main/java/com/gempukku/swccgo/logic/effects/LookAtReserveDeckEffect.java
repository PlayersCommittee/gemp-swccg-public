 ...
 */
public class LookAtReserveDeckEffect extends LookAtCardPileEffect {
     ...
     */
    public LookAtReserveDeckEffect(Action action, String playerId, String cardPileOwner) {
        super(action, playerId, cardPileOwner, Zone.RESERVE_DECK);
    }
}
