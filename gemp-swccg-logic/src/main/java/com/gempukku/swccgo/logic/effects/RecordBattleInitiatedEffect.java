...
class RecordBattleInitiatedEffect extends AbstractSuccessfulEffect {
     ...
     */
    public RecordBattleInitiatedEffect(Action action, PhysicalCard location, boolean isLocalTrouble, Collection<PhysicalCard> localTroubleParticipants) {
        super(action);
    ...
    public void doPlayEffect(SwccgGame game) {
        ...
        gameState.beginBattle(_performingPlayerId, _location, _isLocalTrouble, _localTroubleParticipants);
    }
}
