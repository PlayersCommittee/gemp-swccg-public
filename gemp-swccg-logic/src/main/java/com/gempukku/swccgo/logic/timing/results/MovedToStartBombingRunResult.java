...
/**
 * The effect result that is emitted when a bomber moved to start a Bombing Run.
 */
public class MovedToStartBombingRunResult extends EffectResult implements MovedResult {
    private PhysicalCard _cardMoved;
    private PhysicalCard _movedFrom;
    private PhysicalCard _movedTo;

    /**
     * Creates an effect result that is emitted when a bomber moved to start a Bombing Run.
     ...
     */
    public MovedToStartBombingRunResult(PhysicalCard movedCard, String playerId, PhysicalCard moveFrom, PhysicalCard movedTo) {
        super(Type.MOVED_TO_START_BOMBING_RUN, playerId);
    ...
    public String getText(SwccgGame game) {
        return "Moved " + GameUtils.getCardLink(_cardMoved) + " from " + GameUtils.getCardLink(_movedFrom) + " to " + GameUtils.getCardLink(_movedFrom) + " to start a Bombing Run";
    }
}
