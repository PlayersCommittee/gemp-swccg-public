...
/**
 * The effect result that is emitted when a card is about to be placed out of play from off table.
 */
public class AboutToPlaceCardOutOfPlayFromOffTableResult extends EffectResult {
    private PhysicalCard _source;
    private PhysicalCard _cardToBePlacedOutOfPlay;
    private PreventableCardEffect _effect;

    /**
     * Creates an effect result that is emitted when the specified card is about to be placed out of play from off table.
     ...
     */
    public AboutToPlaceCardOutOfPlayFromOffTableResult(Action action, PhysicalCard cardToBePlacedOutOfPlay, PreventableCardEffect effect) {
     ...
     * @param effect the effect that can be used to prevent the card from being placed out of play
    */
    public AboutToPlaceCardOutOfPlayFromOffTableResult(Action action, String performingPlayerId, PhysicalCard cardToBePlacedOutOfPlay, PreventableCardEffect effect) {
        super(Type.ABOUT_TO_BE_PLACED_OUT_OF_PLAY_FROM_OFF_TABLE, performingPlayerId);
