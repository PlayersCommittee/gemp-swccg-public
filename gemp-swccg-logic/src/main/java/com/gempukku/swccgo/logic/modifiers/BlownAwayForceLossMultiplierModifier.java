...
/**
 * A modifier for multiplying blown away Force loss.
 */
public class BlownAwayForceLossMultiplierModifier extends AbstractModifier {
    private int _blowAwayStateId;
    private Evaluator _evaluator;

    /**
     * Creates a modifier for multiplying blown away Force loss.
     ...
     */
    public BlownAwayForceLossMultiplierModifier(PhysicalCard source, int blowAwayStateId, float modifierAmount, String playerId) {
     ...
     * @param playerId the player whose blown away Force loss is modified
     */
    private BlownAwayForceLossMultiplierModifier(PhysicalCard source, int blowAwayStateId, Condition condition, float modifierAmount, String playerId) {
     ...
     * @param playerId the player whose blown away Force loss is modified
     */
    private BlownAwayForceLossMultiplierModifier(PhysicalCard source, int blowAwayStateId, Condition condition, Evaluator evaluator, String playerId) {
        super(source, null, null, condition, ModifierType.BLOWN_AWAY_FORCE_MULTIPLIER, false);
