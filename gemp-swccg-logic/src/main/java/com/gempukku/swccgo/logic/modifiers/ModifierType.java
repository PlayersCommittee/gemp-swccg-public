...
public enum ModifierType {
    ...
    FORFEIT_VALUE, PRINTED_FORFEIT_VALUE, UNMODIFIABLE_FORFEIT_VALUE, MAY_NOT_HAVE_FORFEIT_VALUE_REDUCED, REMAINS_IN_PLAY_WHEN_FORFEITED, FORFEIT_VALUE_TO_USE, MAY_NOT_HAVE_FORFEIT_VALUE_INCREASED_ABOVE_PRINTED,
