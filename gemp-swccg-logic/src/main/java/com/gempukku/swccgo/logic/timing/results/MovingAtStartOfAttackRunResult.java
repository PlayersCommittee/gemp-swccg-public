...
/**
 * The effect result that is emitted when a starfighter begins to move at start of an Attack Run.
 */
public class MovingAtStartOfAttackRunResult extends EffectResult implements MovingResult {
    private PhysicalCard _cardMoving;
    private PhysicalCard _movingFrom;
    private PhysicalCard _movingTo;

    /**
     * Creates an effect result that is emitted when a starfighter begins to move at start of an Attack Run.
     ...
     */
    public MovingAtStartOfAttackRunResult(PhysicalCard cardMoving, String playerId, PhysicalCard movingFrom, PhysicalCard movingTo) {
        super(Type.MOVING_AT_START_OF_ATTACK_RUN, playerId);
    ...
    public String getText(SwccgGame game) {
        return "Moving " + GameUtils.getCardLink(_cardMoving) + " from " + GameUtils.getCardLink(_movingFrom) + " into " + GameUtils.getCardLink(_movingTo) + " at start of an Attack Run";
    }
}
