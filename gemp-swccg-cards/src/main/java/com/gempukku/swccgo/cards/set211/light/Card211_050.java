...
public class Card211_050 extends AbstractUsedOrLostInterrupt {
    public Card211_050() {
        ...
        setLore("");
        setGameText("USED: /\\ Han's Dice or non-[Maintenance] Han. LOST: If you just lost a gambler, take that gambler into hand. OR Once per game, exchange a card in hand with a Resistance Agent or [Episode VII] Skywalker in Lost Pile.");
    ...
    protected List<PlayInterruptAction> getGameTextTopLevelActions(final String playerId, SwccgGame game, final PhysicalCard self) {
        ...
        if (GameConditions.canTakeCardsIntoHandFromReserveDeck(game, playerId, self, uploadCardGametextActionId)) {
            ...
            action.setText("/\\ Han's Dice or non-[Maintenance] Han");
