 ...
 */
public class Card9_096 extends AbstractAdmiralsOrder {
    public Card9_096() {
        super(Side.DARK, Title.Were_In_Attack_Position_Now, ExpansionSet.DEATH_STAR_II, Rarity.R);
    ...
    protected List<TopLevelGameTextAction> getGameTextTopLevelActions(final String playerId, SwccgGame game, final PhysicalCard self, int gameTextSourceCardId) {
        ...
        Filter filter = Filters.and(Filters.battleground_site, Filters.controlsWith(playerId, self, Filters.or(Filters.general, Filters.commander)),
