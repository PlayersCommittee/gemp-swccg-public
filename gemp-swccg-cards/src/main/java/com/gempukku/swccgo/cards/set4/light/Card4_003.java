 ...
 * Title: Bog-wing
 */
public class Card4_003 extends AbstractCreature {
    public Card4_003() {
        super(Side.LIGHT, 5, 2, null, 2, 0, "Bog-wing", Uniqueness.UNRESTRICTED, ExpansionSet.DAGOBAH, Rarity.C);
        setLore("Large, flying jungle predator. One to five meters long, including tail. Swoops down and grasps victims in its claws. Young are born in mid-flight, as the mother drops from extreme altitude.");
