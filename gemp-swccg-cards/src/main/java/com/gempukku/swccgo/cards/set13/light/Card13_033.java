...
import com.gempukku.swccgo.logic.modifiers.MayUseOtherCharactersCombatCardsModifier;
...
public class Card13_033 extends AbstractRepublic {
    public Card13_033() {
        super(Side.LIGHT, 1, 7, 6, 6, 8, "Obi-Wan Kenobi, Jedi Knight", Uniqueness.UNIQUE, ExpansionSet.REFLECTIONS_III, Rarity.PM);
