...
public class Card501_035 extends AbstractStarfighter {
    public Card501_035() {
        ...
        setGameText("May add 2 passengers. Permanent pilots are •Han and •Chewie, who provide total ability of 5. Power may not be reduced. Immune to Come With Me and attrition < 6.");
