...
public class Card501_024 extends AbstractNormalEffect {
    ...
    protected List<TopLevelGameTextAction> getGameTextTopLevelActions(final String playerId, final SwccgGame game, final PhysicalCard self, int gameTextSourceCardId) {
        ...
        if (GameConditions.isTwicePerGame(game, self, gameTextActionId)
            ...
            if (!game.getGameState().getReserveDeck(playerId).isEmpty()) {
                ...
                revealFromReserve.appendUsage(
                        new TwicePerGameEffect(revealFromReserve));
        ...
        if (GameConditions.isTwicePerGame(game, self, gameTextActionId)
            ...
            revealFromHand.appendUsage(
                    new TwicePerGameEffect(revealFromHand));
    ...
    private void setModifiers(PhysicalCard self, SwccgGame game, PhysicalCard selectedCard) {
        ...
        game.getModifiersEnvironment().addUntilEndOfGameModifier(new KeywordModifier(self, filter, Keyword.BLACK_SUN_AGENT));
    }
}