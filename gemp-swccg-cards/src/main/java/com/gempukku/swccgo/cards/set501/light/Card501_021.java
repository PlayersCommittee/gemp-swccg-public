 ...
 * Type: Interrupt
 * Subtype: Lost
 * Title: The Force Is Strong With This One (V) (Errata)
 */
public class Card501_021 extends AbstractLostInterrupt {
    public Card501_021() {
        ...
        setTestingText("The Force Is Strong With This One (V) (Errata)");
    }
