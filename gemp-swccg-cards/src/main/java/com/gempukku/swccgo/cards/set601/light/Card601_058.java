 ...
 */
public class Card601_058 extends AbstractNormalEffect {
    public Card601_058() {
        super(Side.LIGHT, 4, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, Title.Saitorr_Kal_Fas, Uniqueness.UNRESTRICTED, ExpansionSet.LEGACY, Rarity.V);
