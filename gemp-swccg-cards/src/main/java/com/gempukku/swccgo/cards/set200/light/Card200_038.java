 ...
 */
public class Card200_038 extends AbstractNormalEffect {
    public Card200_038() {
        super(Side.LIGHT, 6, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, "Down With The Emperor!", Uniqueness.UNIQUE, ExpansionSet.SET_0, Rarity.V);
