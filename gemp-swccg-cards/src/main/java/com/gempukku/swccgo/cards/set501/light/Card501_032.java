 ...
 */
public class Card501_032 extends AbstractObjective {
    public Card501_032() {
        ...
        setGameText("Deploy Scarif system, Data Vault (with Stardust there), and Massassi War Room." +
                ...
                "While this side up, once per turn, may [download] Profundity, Rogue One, or a Scarif site." +
    ...
    protected List<TopLevelGameTextAction> getGameTextTopLevelActions(final String playerId, SwccgGame game, final PhysicalCard self, int gameTextSourceCardId) {
        ...
        if (GameConditions.isOncePerTurn(game, self, playerId, gameTextSourceCardId, gameTextActionId)
            ...
            Filter starshipOrSite = Filters.or(Filters.Profundity, Filters.Rogue_One, Filters.Scarif_site);
            ...
            action.setActionMsg("Deploy Profundity, Rogue One, or Scarif site from Reserve Deck");
