...
/**
 * An effect that subtracts a specified amount from opponent's total power.
 */
public class SubtractFromOpponentsTotalPowerEffect extends AbstractSuccessfulEffect {
    private float _amount;

    /**
     * Creates an effect that subtracts a specified amount from opponent's total power.
     * @param action the action performing this effect
     * @param amount the amount
     */
    public SubtractFromOpponentsTotalPowerEffect(Action action, float amount) {
        super(action);
        _amount = amount;
    }
