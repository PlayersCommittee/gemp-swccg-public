 ...
 * Type: Weapon
 * Subtype: Character
 * Title: Darth Renatus's Lightsabers
 */
public class Card303_026 extends AbstractCharacterWeapon {
    public Card303_026() {
        super(Side.DARK, 1, "Darth Renatus's Lightsabers", Uniqueness.RESTRICTED_2, ExpansionSet.SA, Rarity.V);
        ...
        setMatchingCharacterFilter(Filters.Atra);
    }

    @Override
    protected Filter getGameTextValidDeployTargetFilter(SwccgGame game, PhysicalCard self, PlayCardOptionId playCardOptionId, boolean asReact) {
        return Filters.and(Filters.your(self), Filters.Atra);
    }
