...
public class Card9_179 extends AbstractCharacterWeapon {
    ...
    protected List<Modifier> getGameTextAlwaysOnModifiers(SwccgGame game, final PhysicalCard self) {
        ...
        modifiers.add(new DefinedByGameTextDeployCostToTargetModifier(self, 3, Filters.and(Filters.warrior, Filters.not(Filters.Royal_Guard))));
        return modifiers;
    }

    @Override
    protected Filter getGameTextValidDeployTargetFilter(SwccgGame game, PhysicalCard self, PlayCardOptionId playCardOptionId, boolean asReact) {
        return Filters.and(Filters.your(self), Filters.or(Filters.Royal_Guard, Filters.warrior));
    }

    @Override
    protected Filter getGameTextValidToUseWeaponFilter(final SwccgGame game, final PhysicalCard self) {
        return Filters.or(Filters.Royal_Guard, Filters.warrior);
    }
