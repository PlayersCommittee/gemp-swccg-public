...
/**
 * An effect for peeking at the top cards of Reserve Deck and choosing to take a specified number of them into hand.
 */
public class PeekAtTopCardsOfReserveDeckAndChooseCardsToTakeIntoHandEffect extends AbstractSubActionEffect {
     ...
     */
    public PeekAtTopCardsOfReserveDeckAndChooseCardsToTakeIntoHandEffect(Action action, String cardPileOwner, int count, int minCountIntoHand, int maxCountIntoHand) {
        super(action);
