 ...
 */
public abstract class AbstractEpicEventPlayableInsteadOfStartingInterrupt extends AbstractDeployable {
     ...
     */
    protected AbstractEpicEventPlayableInsteadOfStartingInterrupt(Side side, PlayCardZoneOption playCardZoneOption, String title) {
     ...
     */
    protected AbstractEpicEventPlayableInsteadOfStartingInterrupt(Side side, PlayCardZoneOption playCardZoneOption, String title, Uniqueness uniqueness) {
