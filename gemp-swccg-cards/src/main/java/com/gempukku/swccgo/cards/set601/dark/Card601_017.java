...
public class Card601_017 extends AbstractAlien {
    public Card601_017() {
        super(Side.DARK, 2, 3, 4, 2, 4, "Ket Maliss, Shadow Killer", Uniqueness.UNIQUE);
        ...
        setGameText("Adds two to the power of anything he pilots. While with opponent's character of ability > 2, Ket Maliss is power +1 and defense value + 2 and draws one battle destiny if unable to otherwise. Whenever opponent's character was lost from same site, opponent loses 1 Force.");
        addIcons(Icon.A_NEW_HOPE, Icon.BLOCK_8);
