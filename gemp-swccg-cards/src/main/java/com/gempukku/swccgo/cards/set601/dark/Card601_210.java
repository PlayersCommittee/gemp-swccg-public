 ...
 * Title: Onyx 2 (V)
 */
public class Card601_210 extends AbstractStarfighter {
    public Card601_210() {
        super(Side.DARK, 2, 2, 3, null, 4, 4, 3, Title.Onyx_2, Uniqueness.UNIQUE, ExpansionSet.LEGACY, Rarity.V);
        ...
        addIcons(Icon.DEATH_STAR_II, Icon.PILOT, Icon.NAV_COMPUTER, Icon.SCOMP_LINK, Icon.LEGACY_BLOCK_4);
