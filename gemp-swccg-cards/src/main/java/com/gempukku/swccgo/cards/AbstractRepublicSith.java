...
public abstract class AbstractRepublicSith extends AbstractCharacter {
     ...
     */
    protected AbstractRepublicSith(Side side, float destiny, float deployCost, float power, float ability, float forfeit, String title, Uniqueness uniqueness, ExpansionSet expansionSet, Rarity rarity) {
