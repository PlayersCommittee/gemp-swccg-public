 ...
 */
public class Card5_150 extends AbstractLostInterrupt {
    public Card5_150() {
        super(Side.DARK, 4, "Release Your Anger", Uniqueness.UNIQUE, ExpansionSet.CLOUD_CITY, Rarity.R);
        setLore("'Only your hatred can destroy me.'");
