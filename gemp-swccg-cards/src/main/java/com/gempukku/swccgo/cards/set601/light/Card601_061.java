 ...
 * Title: Wokling (V)
 */
public class Card601_061 extends AbstractNormalEffect {
    public Card601_061() {
        super(Side.LIGHT, 2, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, Title.Wokling, Uniqueness.UNIQUE, ExpansionSet.LEGACY, Rarity.V);
