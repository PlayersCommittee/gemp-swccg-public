...
public class Card501_026 extends AbstractJediMaster {
    public Card501_026() {
        ...
        setGameText("Power +3 in a defensive battle (or while you have exactly 2 Jedi on table). Once per game, during your move phase, may relocate to a battleground or Dagobah site as a regular move. Immune to attrition.");
    ...
    protected List<TopLevelGameTextAction> getGameTextTopLevelActions(final String playerId, final SwccgGame game, final PhysicalCard self, int gameTextSourceCardId) {
        ...
        if (GameConditions.isOncePerGame(game, self, gameTextActionId)
            ...
            action.setText("Relocate to a battleground or Dagobah site");
            action.setActionMsg("Relocate to a battleground or Dagobah site");
