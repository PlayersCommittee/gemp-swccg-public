...
public class Card7_289 extends AbstractSite {
    public Card7_289() {
        super(Side.DARK, "Spaceport Docking Bay", Uniqueness.DIAMOND_1, ExpansionSet.SPECIAL_EDITION, Rarity.F);
    ...
    protected List<Modifier> getGameTextDarkSideWhileActiveModifiers(String playerOnDarkSideOfLocation, SwccgGame game, PhysicalCard self) {
        Filter yourStarfighters = Filters.and(Filters.your(playerOnDarkSideOfLocation), Filters.or(Filters.starfighter, Filters.deploysLikeStarfighter));
