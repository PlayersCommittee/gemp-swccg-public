 ...
 */
public class Card105_003 extends AbstractSquadron {
    public Card105_003() {
        super(Side.LIGHT, 2, null, 9, null, 4, 5, 12, "X-wing Assault Squadron", Uniqueness.UNRESTRICTED, ExpansionSet.FIRST_ANTHOLOGY, Rarity.PV);
