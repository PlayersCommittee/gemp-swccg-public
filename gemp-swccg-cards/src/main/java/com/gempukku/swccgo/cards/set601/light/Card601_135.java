 ...
 * Title: Chewie (V)
 */
public class Card601_135 extends AbstractRebel {
    public Card601_135() {
        super(Side.LIGHT, 1, 3, 6, 2, 6, "Chewie", Uniqueness.UNIQUE, ExpansionSet.LEGACY, Rarity.V);
        ...
        addIcons(Icon.PREMIUM, Icon.PILOT, Icon.WARRIOR, Icon.LEGACY_BLOCK_2);
