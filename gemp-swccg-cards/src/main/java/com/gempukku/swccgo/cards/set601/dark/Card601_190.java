 ...
 */
public class Card601_190 extends AbstractNormalEffect {
    public Card601_190() {
        super(Side.DARK, 6, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, "A Day Long Remembered", Uniqueness.UNIQUE, ExpansionSet.LEGACY, Rarity.V);
