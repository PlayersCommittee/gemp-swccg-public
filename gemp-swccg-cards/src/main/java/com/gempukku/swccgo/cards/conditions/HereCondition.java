...
public class HereCondition implements Condition {
    ...
    public boolean isFulfilled(GameState gameState, ModifiersQuerying modifiersQuerying) {
        ...
        if (_exactly)
            return Filters.countActive(gameState.getGame(), card, Filters.and(_filters, Filters.here(card))) == _count;
        else
            return Filters.canSpot(gameState.getGame(), card, _count, Filters.and(_filters, Filters.here(card)));
    }
}
