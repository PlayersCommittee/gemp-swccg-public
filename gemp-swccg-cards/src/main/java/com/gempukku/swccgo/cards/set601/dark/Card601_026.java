 ...
 */
public class Card601_026 extends AbstractNormalEffect {
    public Card601_026() {
        super(Side.DARK, 5, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, "Something Special Planned For Them", Uniqueness.UNIQUE, ExpansionSet.LEGACY, Rarity.V);
