 ...
 */
public class Card9_092 extends AbstractAdmiralsOrder {
    public Card9_092() {
        super(Side.DARK, "Battle Deployment", ExpansionSet.DEATH_STAR_II, Rarity.R);
    ...
    protected List<TopLevelGameTextAction> getGameTextTopLevelActions(final String playerId, SwccgGame game, final PhysicalCard self, int gameTextSourceCardId) {
        GameTextActionId gameTextActionId = GameTextActionId.BATTLE_DEPLOYMENT__DOWNLOAD_COMBAT_VEHICLE;
