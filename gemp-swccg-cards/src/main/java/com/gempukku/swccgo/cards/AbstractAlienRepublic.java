...
public abstract class AbstractAlienRepublic extends AbstractCharacter {
     ...
     */
    protected AbstractAlienRepublic(Side side, float destiny, float deployCost, float power, float ability, float forfeit, String title, Uniqueness uniqueness, ExpansionSet expansionSet, Rarity rarity) {
