 ...
 */
public class Card105_001 extends AbstractRebel {
    public Card105_001() {
        super(Side.LIGHT, 3, 3, 3, 2, 6, "Commander Wedge Antilles", Uniqueness.UNIQUE, ExpansionSet.FIRST_ANTHOLOGY, Rarity.PV);
