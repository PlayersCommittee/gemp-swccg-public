 ...
 * Type: Location
 * Subtype: Site
 * Title: Dandoran: Docking Bay
 */
public class Card302_051 extends AbstractSite {
    public Card302_051() {
        super(Side.LIGHT, Title.Dandoran_Docking_Bay, Title.Dandoran, Uniqueness.UNIQUE, ExpansionSet.DJB_CORE, Rarity.V);
