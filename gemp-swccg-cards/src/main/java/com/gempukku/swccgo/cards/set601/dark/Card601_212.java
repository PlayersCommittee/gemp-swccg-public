 ...
 */
public class Card601_212 extends AbstractStarfighter {
    public Card601_212() {
        super(Side.DARK, 3, 2, 2, null, 3, 5, 4, "Vader's Personal Shuttle", Uniqueness.UNIQUE, ExpansionSet.LEGACY, Rarity.V);
