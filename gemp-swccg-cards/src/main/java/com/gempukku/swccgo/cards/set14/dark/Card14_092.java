...
public class Card14_092 extends AbstractDroid {
    public Card14_092() {
        ...
        setGameText("Adds 3 to power of any AAT he pilots. While piloting an AAT, forfeit +2, draws one battle destiny if unable to otherwise, and your other [Presence] druids at this site are immune to attrition < 4.");
