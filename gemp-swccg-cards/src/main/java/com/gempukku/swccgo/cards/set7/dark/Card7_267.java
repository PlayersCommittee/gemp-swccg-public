 ...
 */
public class Card7_267 extends AbstractUsedInterrupt {
    public Card7_267() {
        super(Side.DARK, 4, "Trooper Sabacc", Uniqueness.UNIQUE, ExpansionSet.SPECIAL_EDITION, Rarity.F);
        setLore("Sabacc is a popular game for off-duty Imperial stormtroopers throughout the galaxy.");
