...
public class Card1_160 extends AbstractSeeker {
    public Card1_160() {
        super(Side.LIGHT, 3, "Tagge Seeker");
    ...
    protected List<RequiredGameTextTriggerAction> getGameTextRequiredAfterTriggers(final SwccgGame game, EffectResult effectResult, final PhysicalCard self, int gameTextSourceCardId) {
        ...
        Filter filter = Filters.and(Filters.or(Filters.Tagge, Filters.warrior), Filters.abilityLessThan(3), Filters.presentWith(self), Filters.canBeTargetedBy(self, TargetingReason.TO_BE_LOST));
