...
public class Card1_316 extends AbstractSeeker {
    ...
    protected List<RequiredGameTextTriggerAction> getGameTextRequiredAfterTriggers(final SwccgGame game, EffectResult effectResult, final PhysicalCard self, int gameTextSourceCardId) {
        ...
        Filter filter = Filters.and(Filters.or(Filters.Han, Filters.alien), Filters.abilityLessThan(3), Filters.presentWith(self), Filters.canBeTargetedBy(self, TargetingReason.TO_BE_LOST));
