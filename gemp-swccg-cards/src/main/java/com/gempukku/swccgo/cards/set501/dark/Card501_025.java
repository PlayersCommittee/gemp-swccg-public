 ...
 * Type: Starship
 * Subtype: Capital
 * Title: Invisible Hand (Errata)
 */
public class Card501_025 extends AbstractCapitalStarship {
    public Card501_025() {
        super(Side.DARK, 2, 5, 6, 5, null, 3, 8, Title.Invisible_Hand, Uniqueness.UNIQUE);
        setGameText("May add 3 pilots, 5 passengers, and 4 [Trade Federation] starfighters. Permanent pilot provides ability of 3. Adds one battle destiny if Grievous on table. Immune to attrition < 5 (< 9 while alone).");
        ...
        setTestingText("Invisible Hand (Errata)");
    }
    ...
    protected List<Modifier> getGameTextWhileActiveInPlayModifiers(SwccgGame game, final PhysicalCard self) {
        ...
        modifiers.add(new ImmuneToAttritionLessThanModifier(self, new ConditionEvaluator(5, 9, new AloneCondition(self))));
