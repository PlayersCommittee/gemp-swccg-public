...
public class Card601_262 extends AbstractAlien {
    public Card601_262() {
        ...
        setGameText("[Pilot] 2. For each of opponent's non-battleground locations on table, your Force generation is +1. Your leaders are deploy -2 to same site. Once per game, may [upload] an Immediate Effect.");
        addIcons(Icon.SPECIAL_EDITION, Icon.PILOT, Icon.LEGACY_BLOCK_2);
    ...
    protected List<Modifier> getGameTextWhileActiveInPlayModifiers(SwccgGame game, final PhysicalCard self) {
        ...
        modifiers.add(new DeployCostToLocationModifier(self, Filters.and(Filters.your(self), Filters.leader), -2, Filters.sameSite(self)));
        return modifiers;
    }
