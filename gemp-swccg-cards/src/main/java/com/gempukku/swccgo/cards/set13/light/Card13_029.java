...
public class Card13_029 extends AbstractRebel {
    ...
    protected List<Modifier> getGameTextWhileActiveInPlayModifiers(SwccgGame game, final PhysicalCard self) {
        ...
        modifiers.add(new ResetTotalAbilityModifier(self, Filters.sameSite(self),
                new AndCondition(new CantSpotCondition(self, Filters.and(Filters.opponents(self), Filters.non_alien_character, Filters.here(self))),
                        new NotCondition(new GameTextModificationCondition(self, ModifyGameTextType.LEIA_REFLECTIONS_III__MAY_NOT_CANCEL_FORCE_DRAINS_OR_REDUCE_ABILITY))),
    ...
    protected List<OptionalGameTextTriggerAction> getGameTextOptionalAfterTriggers(String playerId, SwccgGame game, EffectResult effectResult, final PhysicalCard self, int gameTextSourceCardId) {
        ...
        if (TriggerConditions.forceDrainInitiatedAt(game, effectResult, Filters.relatedSite(self))
                ...
                && !GameConditions.hasGameTextModification(game, self, ModifyGameTextType.LEIA_REFLECTIONS_III__MAY_NOT_CANCEL_FORCE_DRAINS_OR_REDUCE_ABILITY)) {
