 ...
 */
public class Card501_016 extends AbstractObjective {
    public Card501_016() {
        super(Side.DARK, 0, Title.Hunt_Down_And_Destroy_The_Jedi);
        setFrontOfDoubleSidedCard(true);
        setVirtualSuffix(true);
        setGameText("Deploy Vader's Castle, [Set 13] Visage Of The Emperor, and a location with exactly one [DS] icon.\n" +
        ...
        setTestingText("Hunt Down And Destroy The Jedi (V) (ERRATA)");
    }
    ...
    protected ObjectiveDeployedTriggerAction getGameTextWhenDeployedAction(String playerId, SwccgGame game, PhysicalCard self, int gameTextSourceCardId) {
        ...
        action.appendRequiredEffect(
                new DeployCardFromReserveDeckEffect(action, Filters.and(Filters.location, Filters.iconCount(Icon.DARK_FORCE, 1)), true, false) {
                    @Override
                    public String getChoiceText() {
