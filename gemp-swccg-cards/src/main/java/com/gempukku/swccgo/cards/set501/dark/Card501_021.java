...
public class Card501_021 extends AbstractNormalEffect {
    public Card501_021() {
        ...
        setGameText("Deploy on table. Lost if your non-Imperial character (or starship) on table. Unless you occupy fewer locations than opponent: if you win a battle, retrieve an Imperial; and, during battle, if you just drew an Imperial for destiny, may cancel and redraw that destiny. [Immune to Alter.]");
    ...
    protected List<OptionalGameTextTriggerAction> getGameTextOptionalAfterTriggers(final String playerId, SwccgGame game, final EffectResult effectResult, final PhysicalCard self, int gameTextSourceCardId) {
        ...
        if (TriggerConditions.isDestinyJustDrawnBy(game, effectResult, playerId)
            ...
            action.setText("Cancel and redraw destiny");
