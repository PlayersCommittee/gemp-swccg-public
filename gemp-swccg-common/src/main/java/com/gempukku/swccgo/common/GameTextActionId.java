...
public enum GameTextActionId {
    ...
    FINAL_ORDER__DOWNLOAD_CARD(true),
    ...
    TWILIGHT_IS_UPON_ME__UPLOAD_THE_FORCE_IS_STRONG_WITH_THIS_ONE_OR_ANAKIN_SKYWALKER(true, true, false, false, false, true),
    ...
    THE_CLIENT__TAKE_DESTINY_INTO_HAND(false, true),
