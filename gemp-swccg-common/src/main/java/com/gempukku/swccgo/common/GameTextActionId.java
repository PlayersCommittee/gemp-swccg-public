...
public enum GameTextActionId {
    ...
    VISAGE__DEPLOY_LIGHTSABER(true),
    ...
    HUNT_DOWN_V__TAKE_LIGHTSABER_INTO_HAND_FROM_LOST_PILE(true, true),
    ...
    MAKE_TEN_MEN_FEEL_LIKE_A_HUNDRED_DOWNLOAD_SAW(true, true),
    ...
    R2_D2_V__GOES_TO_USED_WHEN_LOST(false, true),
    ...
    SAW_GERRERA__CANCEL_INTERRUPT(false, true),
