...
public enum GameTextActionId {
    ...
    VADERS_ANGER__UPDLOAD_SITH_FURY(true),
    ...
    XIZORS_PALACE_SEWER__RETRIEVE_BLACK_SUN_AGENT_INTO_HAND(true, true),
    XIZORS_PALACE_SEWER__RETRIEVE_DASH_INTO_HAND(true, true),
