 ...
 * Set: Shadow Academy
 * Type: Effect
 * Title: Dark Side Corruption
 */
public class Card303_024 extends AbstractNormalEffect {
    public Card303_024() {
        super(Side.LIGHT, 4, null, Title.Dark_Side_Corruption, Uniqueness.UNRESTRICTED, ExpansionSet.SA, Rarity.U);
    ...
    protected List<PlayCardOption> getGameTextPlayCardOptions() {
        ...
        playCardOptions.add(new PlayCardOption(PlayCardOptionId.PLAY_CARD_OPTION_1, PlayCardZoneOption.ATTACHED, "Deploy on an Apprentice"));
        playCardOptions.add(new PlayCardOption(PlayCardOptionId.PLAY_CARD_OPTION_2, PlayCardZoneOption.ATTACHED, "Deploy on a Character"));
    ...
    protected Filter getGameTextValidDeployTargetFilter(SwccgGame game, PhysicalCard self, PlayCardOptionId playCardOptionId, boolean asReact) {
        if (playCardOptionId == PlayCardOptionId.PLAY_CARD_OPTION_1)
            ...
            return Filters.and(Filters.opponents(self), Filters.and(Filters.character, Filters.abilityMoreThan(3)), Filters.at(Filters.site));
        else
            return Filters.none;
    }
