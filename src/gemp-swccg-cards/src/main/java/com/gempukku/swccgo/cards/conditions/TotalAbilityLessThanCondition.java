...
/**
 * A condition that is fulfilled when the specified player has less than a specified total ability at a location accepted
 * by the specified filter.
 */
public class TotalAbilityLessThanCondition implements Condition {
    private String _playerId;
    private float _ability;
    private Filter _locationFilter;

    /**
     * Creates a condition that is fulfilled when the specified player has less than X total ability at a location accepted
     * by the specified filter.
     * @param playerId the filter
     * @param ability the amount of total ability
     * @param locationFilter the location filter
     */
    public TotalAbilityLessThanCondition(String playerId, float ability, Filterable locationFilter) {
        _playerId = playerId;
        _ability = ability;
