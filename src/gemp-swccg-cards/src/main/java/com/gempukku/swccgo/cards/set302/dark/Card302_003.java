 ...
 * Type: Weapon
 * Subtype: Character
 * Title: Brotherhood Lightsaber
 */
public class Card302_003 extends AbstractCharacterWeapon {
    public Card302_003() {
        super(Side.DARK, 2, "Brotherhood Lightsaber", Uniqueness.UNRESTRICTED, ExpansionSet.DJB_CORE, Rarity.V);
        setLore("Before reaching the Equite ranks all Force sensitive members of the Brotherhood have access to an armory lightsaber. While functional it lacks the customizations an Equite can make.");
