 ...
 */
public class Card12_037 extends AbstractNormalEffect {
    public Card12_037() {
        super(Side.LIGHT, 5, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, "A Tragedy Has Occurred", Uniqueness.UNIQUE, ExpansionSet.CORUSCANT, Rarity.U);
    ...
    protected List<OptionalGameTextTriggerAction> getGameTextOptionalBeforeTriggers(final String playerId, SwccgGame game, Effect effect, final PhysicalCard self, int gameTextSourceCardId) {
        GameTextActionId gameTextActionId = GameTextActionId.A_TRAGEDY_HAS_OCCURRED__STACK_INTERRUPT;
