...
public class Card10_052 extends AbstractNormalEffect {
    public Card10_052() {
        super(Side.DARK, 1, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, "There Is No Try & Oppressive Enforcement", Uniqueness.UNIQUE, ExpansionSet.REFLECTIONS_II, Rarity.PM);
