 ...
 * Title: Caller
 */
public class Card1_200 extends AbstractCharacterDevice {
    public Card1_200() {
        super(Side.DARK, 6, "Caller", Uniqueness.UNRESTRICTED, ExpansionSet.PREMIERE, Rarity.U2);
    ...
    protected Filter getGameTextValidDeployTargetFilter(SwccgGame game, PhysicalCard self, PlayCardOptionId playCardOptionId, boolean asReact) {
        return Filters.and(Filters.your(self), Filters.or(Filters.Imperial, Filters.Jawa));
    }

    @Override
    protected Filter getGameTextValidToUseDeviceFilter(final SwccgGame game, final PhysicalCard self) {
        return Filters.or(Filters.Imperial, Filters.Jawa);
    }
