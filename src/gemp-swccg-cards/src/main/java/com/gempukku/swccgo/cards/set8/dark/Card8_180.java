...
public class Card8_180 extends AbstractVehicleWeapon {
    ...
    protected List<Modifier> getGameTextAlwaysOnModifiers(SwccgGame game, final PhysicalCard self) {
        ...
        modifiers.add(new DefinedByGameTextDeployCostToTargetModifier(self, 1, Filters.speeder_bike));
        modifiers.add(new DefinedByGameTextDeployCostToTargetModifier(self, 2, Filters.swoop));
        return modifiers;
    }

    @Override
    protected Filter getGameTextValidDeployTargetFilter(SwccgGame game, PhysicalCard self, PlayCardOptionId playCardOptionId, boolean asReact) {
        return Filters.and(Filters.your(self), Filters.or(Filters.speeder_bike, Filters.swoop));
    }

    @Override
    protected Filter getGameTextValidToUseWeaponFilter(final SwccgGame game, final PhysicalCard self) {
        return Filters.or(Filters.speeder_bike, Filters.swoop);
    }
