...
public class Card2_080 extends AbstractSeeker {
    public Card2_080() {
        super(Side.LIGHT, 3, "Motti Seeker", Uniqueness.UNRESTRICTED, ExpansionSet.A_NEW_HOPE, Rarity.R2);
    ...
    protected Filter getEligibleSeekerTargetFilter(SwccgGame game, PhysicalCard self) {
        return Filters.and(Filters.or(Filters.Motti, Filters.pilot), Filters.abilityLessThan(3));
    }
}
