...
public class Card212_003 extends AbstractAlien {
    public Card212_003() {
        ...
        setGameText("Permanent weapon is •Aurra Sing's Blaster Rifle (may target a character for free; if targeting a Jedi, draw two destiny, otherwise draw destiny; target hit, and its forfeit = 0, if total destiny +1 > defense value).");
    ...
    protected AbstractPermanentWeapon getGameTextPermanentWeapon() {
        AbstractPermanentWeapon permanentWeapon = new AbstractPermanentWeapon(Persona.AURRAS_BLASTER_RIFLE, "Aurra Sing's Blaster Rifle") {
            @Override
