 ...
 */
public class Card223_028 extends AbstractNormalEffect {
    public Card223_028() {
        super(Side.DARK, 5, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, "Your Eyes Can Deceive You", Uniqueness.UNRESTRICTED, ExpansionSet.SET_23, Rarity.V);
