 ...
 */
public class Card304_097 extends AbstractSite {
    public Card304_097() {
        super(Side.DARK, Title.Koudooine_Docking_Bay, Title.Koudooine, Uniqueness.UNIQUE, ExpansionSet.GREAT_HUTT_EXPANSION, Rarity.V);
