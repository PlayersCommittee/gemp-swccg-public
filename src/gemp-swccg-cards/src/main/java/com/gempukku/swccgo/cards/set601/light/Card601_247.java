 ...
 */
public class Card601_247 extends AbstractStarfighter {
    public Card601_247() {
        super(Side.LIGHT, 2, 4, 4, null, 4, 5, 4, "Booster In Pulsar Skate", Uniqueness.UNIQUE, ExpansionSet.LEGACY, Rarity.V);
        ...
        addIcons(Icon.REFLECTIONS_II, Icon.INDEPENDENT, Icon.PILOT, Icon.NAV_COMPUTER, Icon.SCOMP_LINK, Icon.LEGACY_BLOCK_4);
