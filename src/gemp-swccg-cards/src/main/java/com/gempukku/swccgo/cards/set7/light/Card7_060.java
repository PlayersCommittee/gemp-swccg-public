 ...
 */
public class Card7_060 extends AbstractNormalEffect {
    public Card7_060() {
        super(Side.LIGHT, 4, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, Title.Draw_Their_Fire, Uniqueness.UNIQUE, ExpansionSet.SPECIAL_EDITION, Rarity.U);
        setLore("'I'm going to cut across the axis and try and draw their fire.'");
