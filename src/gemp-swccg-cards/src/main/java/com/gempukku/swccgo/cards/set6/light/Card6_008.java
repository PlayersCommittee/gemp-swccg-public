...
import com.gempukku.swccgo.logic.modifiers.MayNotParticipateInBattleInitiatedByOwnerModifier;
...
public class Card6_008 extends AbstractAlien {
    public Card6_008() {
        super(Side.LIGHT, 2, 3, 0, 4, 4, "B'omarr Monk", Uniqueness.RESTRICTED_3, ExpansionSet.JABBAS_PALACE, Rarity.C);
