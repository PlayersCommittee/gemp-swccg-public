 ...
 */
public class Card601_206 extends AbstractCapitalStarship {
    public Card601_206() {
        super(Side.DARK, 1, 4, 6, 4, null, 4, 6, "Bossk In Hound's Tooth", Uniqueness.UNIQUE, ExpansionSet.LEGACY, Rarity.V);
        ...
        addIcons(Icon.SPECIAL_EDITION, Icon.INDEPENDENT, Icon.PILOT, Icon.NAV_COMPUTER, Icon.SCOMP_LINK, Icon.LEGACY_BLOCK_6);
