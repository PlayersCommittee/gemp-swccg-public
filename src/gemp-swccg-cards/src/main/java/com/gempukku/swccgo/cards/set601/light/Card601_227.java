 ...
 * Title: Leia (V)
 */
public class Card601_227 extends AbstractRebel {
    public Card601_227() {
        super(Side.LIGHT, 1, 3, 3, 4, 5, "Leia", Uniqueness.UNIQUE, ExpansionSet.LEGACY, Rarity.V);
        ...
        addIcons(Icon.PREMIUM, Icon.WARRIOR, Icon.LEGACY_BLOCK_1);
