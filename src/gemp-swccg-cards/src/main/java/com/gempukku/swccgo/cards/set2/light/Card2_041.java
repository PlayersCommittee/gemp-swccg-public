 ...
 */
public class Card2_041 extends AbstractImmediateEffect {
    public Card2_041() {
        super(Side.LIGHT, 3, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, "What're You Tryin' To Push On Us?", Uniqueness.RESTRICTED_3, ExpansionSet.A_NEW_HOPE, Rarity.U2);
        setLore("Moisture farmers like Own Lars must be on the lookout for repeated (and blatant) ploys by Jawas.");
