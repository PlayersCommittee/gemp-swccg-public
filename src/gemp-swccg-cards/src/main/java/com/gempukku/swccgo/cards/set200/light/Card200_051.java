 ...
 */
public class Card200_051 extends AbstractUsedOrStartingInterrupt {
    public Card200_051() {
        super(Side.LIGHT, 5, "Don't Tread On Me", Uniqueness.UNRESTRICTED, ExpansionSet.SET_0, Rarity.V);
