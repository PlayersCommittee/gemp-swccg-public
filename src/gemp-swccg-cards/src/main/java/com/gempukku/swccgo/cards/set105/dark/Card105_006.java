 ...
 */
public class Card105_006 extends AbstractNormalEffect {
    public Card105_006() {
        super(Side.DARK, 3, PlayCardZoneOption.ATTACHED, Title.Jabbas_Influence, Uniqueness.UNIQUE, ExpansionSet.FIRST_ANTHOLOGY, Rarity.PV);
