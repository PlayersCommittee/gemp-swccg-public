...
public abstract class AbstractAlienImperial extends AbstractCharacter {
     ...
     */
    protected AbstractAlienImperial(Side side, float destiny, float deployCost, float power, float ability, float forfeit, String title, Uniqueness uniqueness, ExpansionSet expansionSet, Rarity rarity) {
