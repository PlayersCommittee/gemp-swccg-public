 ...
 * Title: Strikeforce (V)
 */
public class Card200_046 extends AbstractNormalEffect {
    public Card200_046() {
        super(Side.LIGHT, 5, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, "Strikeforce", Uniqueness.UNIQUE, ExpansionSet.SET_0, Rarity.V);
