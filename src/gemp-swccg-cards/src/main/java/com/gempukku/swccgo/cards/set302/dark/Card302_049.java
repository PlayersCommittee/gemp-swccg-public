 ...
 */
public class Card302_049 extends AbstractSite {
    public Card302_049() {
        super(Side.DARK, "Dandoran: Imperial Outpost", Title.Dandoran, Uniqueness.UNIQUE, ExpansionSet.DJB_CORE, Rarity.V);
	    setLocationDarkSideGameText("Force drain +1 here. If you initiate a battle here, add one battle destiny.");
