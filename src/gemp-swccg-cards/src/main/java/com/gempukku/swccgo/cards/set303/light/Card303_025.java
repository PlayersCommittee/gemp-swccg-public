 ...
 * Type: Weapon
 * Subtype: Character
 * Title: Marick Tyris Arconae's Lightsaber
 */
public class Card303_025 extends AbstractCharacterWeapon {
    public Card303_025() {
        ...
        setMatchingCharacterFilter(Filters.Marick);
    }

    @Override
    protected Filter getGameTextValidDeployTargetFilter(SwccgGame game, PhysicalCard self, PlayCardOptionId playCardOptionId, boolean asReact) {
        return Filters.and(Filters.your(self), Filters.Marick);
    }

    @Override
    protected Filter getGameTextValidToUseWeaponFilter(final SwccgGame game, final PhysicalCard self) {
        return Filters.Marick;
    }
