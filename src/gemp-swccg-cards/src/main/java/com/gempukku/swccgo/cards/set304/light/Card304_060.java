...
public class Card304_060 extends AbstractAlien {
    public Card304_060() {
        ...
        setLore("Sqygorn serves as Candon Coburn's gangster enforcer. whenever there's a job that Candon wants done cleanly and quickly, Sqygorn's who he calls. Sqygorn, however, is just in it for the spice.");
