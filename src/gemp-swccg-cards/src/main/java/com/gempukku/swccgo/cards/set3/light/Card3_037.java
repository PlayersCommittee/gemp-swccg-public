 ...
 * Title: Ice Storm
 */
public class Card3_037 extends AbstractMobileEffect {
    public Card3_037() {
        super(Side.LIGHT, 3, Title.Ice_Storm, Uniqueness.UNIQUE, ExpansionSet.HOTH, Rarity.U1);
        setLore("The intensity of a Hoth ice storm is exacerbated by its speed and erratic movement across the frozen planet.");
        setGameText("Deploy at outermost marker. All characters present at same exterior site are missing. Each turn, during your control phase, storm moves to next marker, reversing direction at innermost marker. Mobile Effect lost when moved beyond outermost marker.");
        addIcons(Icon.HOTH);
    }
