 ...
 */
public class Card13_032 extends AbstractSite {
    public Card13_032() {
        super(Side.LIGHT, Title.Theed_Palace_Generator_Core, Title.Naboo, Uniqueness.UNIQUE, ExpansionSet.REFLECTIONS_III, Rarity.PM);
