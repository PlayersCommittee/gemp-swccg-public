 ...
 * Type: Starship
 * Subtype: Capital
 * Title: Remembrance of Seher
 */
public class Card305_008 extends AbstractCapitalStarship {
    public Card305_008() {
    ...
    protected List<Modifier> getGameTextWhileActiveInPlayModifiers(SwccgGame game, final PhysicalCard self) {
        ...
        modifiers.add(new ImmuneToAttritionLessThanModifier(self, new ConditionEvaluator(3, 4, new HasAboardCondition(self, Filters.COU_leader))));
        return modifiers;
    }
}
