...
public class Card304_050 extends AbstractAlien {
    public Card304_050() {
        ...
        setGameText("Subtracts 1 from deploy cost of Gangsters at same site (Candon Coburn deploy free). During battle, subtracts X from opponent's total power, where X = number of your musicians present (+2 if battling Luke or Han, or +4 if both).");
