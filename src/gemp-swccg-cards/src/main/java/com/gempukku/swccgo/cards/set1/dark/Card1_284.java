 ...
 */
public class Card1_284 extends AbstractSite {
    public Card1_284() {
        super(Side.DARK, Title.Detention_Block_Corridor, Title.Death_Star, Uniqueness.UNIQUE, ExpansionSet.PREMIERE, Rarity.C1);
