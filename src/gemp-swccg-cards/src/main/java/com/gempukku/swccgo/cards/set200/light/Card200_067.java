 ...
 */
public class Card200_067 extends AbstractStarfighter {
    public Card200_067() {
        super(Side.LIGHT, 2, 4, 6, null, 5, 5, 6, "Wedge In Red Squadron 1", Uniqueness.UNIQUE, ExpansionSet.SET_0, Rarity.V);
