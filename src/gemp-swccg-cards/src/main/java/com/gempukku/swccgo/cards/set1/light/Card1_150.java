 ...
 * Title: Sandcrawler
 */
public class Card1_150 extends AbstractTransportVehicle {
    public Card1_150() {
        super(Side.LIGHT, 2, 3, 3, 3, null, 2, 5, "Sandcrawler", Uniqueness.UNRESTRICTED, ExpansionSet.PREMIERE, Rarity.R2);
        setLore("Warren-like enclosed homes for Jawa tribes. Protects against Tatooine predators. Originally mining vehicles. Jawas claimed them when mines abandoned. No two look alike.");
