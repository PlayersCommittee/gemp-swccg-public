...
import com.gempukku.swccgo.cards.effects.PayEnterStarshipOrVehicleSiteCostEffect;
import com.gempukku.swccgo.filters.Filter;
import com.gempukku.swccgo.game.PhysicalCard;
import com.gempukku.swccgo.game.SwccgGame;
import com.gempukku.swccgo.logic.GameUtils;
import com.gempukku.swccgo.logic.actions.AbstractTopLevelRuleAction;
import com.gempukku.swccgo.logic.effects.EnterStarshipOrVehicleSiteEffect;
...
/**
 * An action to enter a starship/vehicle site from the site the related starship/vehicle is present at.
 */
public class EnterStarshipOrVehicleSiteAction extends AbstractTopLevelRuleAction {
    ...
    /**
     * Creates an action to enter a starship or vehicle site from the site the related starship/vehicle is present at.
     ...
     */
    public EnterStarshipOrVehicleSiteAction(final String playerId, final PhysicalCard card, boolean forFree, boolean asReact, final Filter moveTargetFilter) {
        super(card, playerId);
        _cardToMove = card;
        _forFree = forFree;
        _asReact = asReact;
        ...
        appendTargeting(
                new ChooseCardOnTableEffect(_that, playerId, "Choose where to move " + GameUtils.getCardLink(card), moveTargetFilter) {
                    ...
                    protected void cardSelected(PhysicalCard selectedCard) {
                        ...
                        _moveCardEffect = new EnterStarshipOrVehicleSiteEffect(_that, card, selectedCard, _asReact);
                    }
                }
        );
    }
    ...
    public String getText() {
        return "Enter starship or vehicle site";
    }
        ...
        if (!isAnyCostFailed()) {
            ...
            if (!_useForceCostApplied) {
                ...
                if (!_forFree && !_asReact) {
                    appendCost(new PayEnterStarshipOrVehicleSiteCostEffect(_that, getPerformingPlayer(), _cardToMove, _siteToMoveTo, false, 0));
                    return getNextCost();
                }
            }
