 ...
 */
public class Card105_005 extends AbstractSquadron {
    public Card105_005() {
        super(Side.DARK, 1, 12, 3, null, 3, null, 10, "Death Star Assault Squadron", Uniqueness.UNIQUE, ExpansionSet.FIRST_ANTHOLOGY, Rarity.PV);
