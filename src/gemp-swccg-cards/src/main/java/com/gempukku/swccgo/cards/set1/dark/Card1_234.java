 ...
 * Title: Alter
 */
public class Card1_234 extends AbstractUsedInterrupt {
    public Card1_234() {
        super(Side.DARK, 4, Title.Alter, Uniqueness.UNRESTRICTED, ExpansionSet.PREMIERE, Rarity.U1);
    ...
    protected List<PlayInterruptAction> getGameTextTopLevelActions(final String playerId, SwccgGame game, final PhysicalCard self) {
        final Filter effectFilter = Filters.and(Filters.or(Filters.Effect, Filters.Utinni_Effect), Filters.not(Filters.dejarikHologramAtHolosite));
