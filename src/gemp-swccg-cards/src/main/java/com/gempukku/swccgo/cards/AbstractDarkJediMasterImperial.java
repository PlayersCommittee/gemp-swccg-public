...
public abstract class AbstractDarkJediMasterImperial extends AbstractCharacter {
     ...
     */
    protected AbstractDarkJediMasterImperial(Side side, float destiny, float deployCost, float power, float ability, float forfeit, String title, Uniqueness uniqueness, ExpansionSet expansionSet, Rarity rarity) {
