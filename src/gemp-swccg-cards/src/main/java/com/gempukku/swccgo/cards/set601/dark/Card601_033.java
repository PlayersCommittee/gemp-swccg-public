 ...
 */
public class Card601_033 extends AbstractDefensiveShield {
    public Card601_033() {
        super(Side.DARK, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, Title.Death_Star_Sentry, ExpansionSet.LEGACY, Rarity.V);
