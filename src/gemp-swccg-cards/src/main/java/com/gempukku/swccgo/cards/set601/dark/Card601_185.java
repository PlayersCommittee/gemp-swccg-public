 ...
 * Title: IG-88 (V)
 */
public class Card601_185 extends AbstractDroid {
    public Card601_185() {
        super(Side.DARK, 1, 4, 4, 5, "IG-88", Uniqueness.UNIQUE, ExpansionSet.LEGACY, Rarity.V);
        ...
        addIcons(Icon.DAGOBAH, Icon.PILOT, Icon.PRESENCE, Icon.LEGACY_BLOCK_2);
