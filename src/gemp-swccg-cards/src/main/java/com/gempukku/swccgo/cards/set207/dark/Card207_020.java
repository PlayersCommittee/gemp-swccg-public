 ...
 */
public class Card207_020 extends AbstractImperial {
    public Card207_020() {
        super(Side.DARK, 2, 3, 3, 3, 5, Title.Krennic, Uniqueness.UNIQUE, ExpansionSet.SET_7, Rarity.V);
    ...
    protected List<Modifier> getGameTextWhileActiveInPlayModifiers(SwccgGame game, final PhysicalCard self) {
        ...
        Condition atSite = new AtCondition(self, Filters.site);
        Filter here = Filters.here(self);

        List<Modifier> modifiers = new LinkedList<Modifier>();
        modifiers.add(new AddsPowerToPilotedBySelfModifier(self, 2));
        modifiers.add(new MayNotCancelBattleDestinyModifier(self, here, playerId, atSite, opponent));
        modifiers.add(new MayNotModifyBattleDestinyModifier(self, here, playerId, atSite, opponent));
        return modifiers;
    }
