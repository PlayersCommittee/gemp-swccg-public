 ...
 * Type: Weapon
 * Subtype: Character
 * Title: Armory Lightsaber
 */
public class Card302_007 extends AbstractCharacterWeapon {
    public Card302_007() {
        super(Side.LIGHT, 2, "Armory Lightsaber", Uniqueness.UNRESTRICTED, ExpansionSet.DJB_CORE, Rarity.U1);
        setLore("NOt as clumsy or random as a blaster. The Brotherhood encourages its Force sensitive members to explore the art of the lightsaber. All students of the Force haev access to an Armory saber.");
