 ...
 * Type: Location
 * Subtype: Site
 * Title: Arx: Desert Space Port 'Docking Bay'
 */
public class Card302_009 extends AbstractSite {
    public Card302_009() {
        super(Side.LIGHT, Title.Desert_Space_Port_Docking_Bay, Title.Arx, Uniqueness.UNIQUE, ExpansionSet.DJB_CORE, Rarity.V);
