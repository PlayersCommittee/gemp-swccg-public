 ...
 */
public class Card601_194 extends AbstractNormalEffect {
    public Card601_194() {
        super(Side.DARK, 3, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, Title.Youll_Be_Dead, Uniqueness.UNIQUE, ExpansionSet.LEGACY, Rarity.V);
