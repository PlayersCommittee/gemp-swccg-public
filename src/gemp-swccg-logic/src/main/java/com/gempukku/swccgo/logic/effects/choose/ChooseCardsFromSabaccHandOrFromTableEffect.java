...
/**
 * An effect that causes the specified player to choose cards from a sabacc hand or from table.
 *
 ...
 */
public abstract class ChooseCardsFromSabaccHandOrFromTableEffect extends AbstractStandardEffect {
    ...
    /**
     * Creates an effect that causes the player to choose cards from a sabacc hand or from table.
     ...
     */
    public ChooseCardsFromSabaccHandOrFromTableEffect(Action action, String playerId, String handOwner, int minimum, int maximum, Filterable filters) {
        this(action, playerId, handOwner, minimum, maximum, true, filters);
    }

    /**
     * Creates an effect that causes the player to choose cards from a sabacc hand or from table accepted by the specified filter.
     * @param action the action performing this effect
     * @param playerId the player choosing cards
     * @param handOwner the owner of the sabacc hand
     * @param minimum the minimum number of cards to choose
     ...
     * @param filters the filter
     */
    public ChooseCardsFromSabaccHandOrFromTableEffect(Action action, String playerId, String handOwner, int minimum, int maximum, boolean shortcut, Filterable filters) {
        super(action);
        _playerId = playerId;
    ...
    protected FullEffectResult playEffectReturningResult(final SwccgGame game) {
        ...
        selectableCards.addAll(Filters.filterActive(game, null, _filters));
