...
/**
 * A move cost modifier when moving from specified locations to specified locations using landspeed.
 */
public class MoveCostFromLocationToLocationUsingLandspeedModifier extends AbstractModifier {
    private Evaluator _evaluator;
    private Filter _fromLocationFilter;
    private Filter _toLocationFilter;

    /**
     * Creates a move cost modifier when moving from specified locations to specified locations using landspeed.
     ...
     */
    public MoveCostFromLocationToLocationUsingLandspeedModifier(PhysicalCard source, int modifierAmount, Filterable fromLocationFilter, Filterable toLocationFilter) {
     ...
     * @param toLocationFilter the to location filter
     */
    public MoveCostFromLocationToLocationUsingLandspeedModifier(PhysicalCard source, Filterable affectFilter, int modifierAmount, Filterable fromLocationFilter, Filterable toLocationFilter) {
     ...
     * @param toLocationFilter the to location filter
     */
    public MoveCostFromLocationToLocationUsingLandspeedModifier(PhysicalCard source, Filterable affectFilter, Condition condition, int modifierAmount, Filterable fromLocationFilter, Filterable toLocationFilter) {
     ...
     * @param toLocationFilter the to location filter
     */
    public MoveCostFromLocationToLocationUsingLandspeedModifier(PhysicalCard source, Filterable affectFilter, Condition condition, Evaluator evaluator, Filterable fromLocationFilter, Filterable toLocationFilter) {
        super(source, null, Filters.and(Filters.in_play, affectFilter), condition, ModifierType.MOVE_COST_FROM_LOCATION_TO_LOCATION_USING_LANDSPEED, false);
