...
/**
 * A modifier for not being able to move to specified locations.
 */
public class MayNotMoveToLocationModifier extends AbstractModifier {
    private Filter _affectedFilter;

    /**
     * Creates a modifier for not being able to move to specified locations.
     ...
     */
    public MayNotMoveToLocationModifier(PhysicalCard source, Filterable locationFilter) {
     ...
     * @param locationFilter the filter for locations that affected cards may not move to
     */
    public MayNotMoveToLocationModifier(PhysicalCard source, Filterable affectFilter, Filterable locationFilter) {
     ...
     * @param locationFilter the filter for locations that affected cards may not move to
     */
    public MayNotMoveToLocationModifier(PhysicalCard source, Filterable affectFilter, Condition condition, Filterable locationFilter) {
        super(source, null, Filters.and(Filters.location, locationFilter), condition, ModifierType.MAY_NOT_MOVE_TO_LOCATION, true);
