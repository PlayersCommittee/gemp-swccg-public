...
/**
 * The effect result that is emitted when a card begins to enter a starship/vehicle site from the site the related starship/vehicle
 * is present at.
 */
public class EnteringStarshipOrVehicleSiteResult extends EffectResult implements MovingResult {
    ...
    /**
     * Creates an effect result that is emitted when a card begins to enter a starship/vehicle site from the site the related starship/vehicle
     * is present at.
     ...
     */
    public EnteringStarshipOrVehicleSiteResult(PhysicalCard cardMoving, String playerId, PhysicalCard movingFrom, PhysicalCard movingTo, boolean asReact) {
        super(Type.ENTERING_STARSHIP_OR_VEHICLE_SITE, playerId);
