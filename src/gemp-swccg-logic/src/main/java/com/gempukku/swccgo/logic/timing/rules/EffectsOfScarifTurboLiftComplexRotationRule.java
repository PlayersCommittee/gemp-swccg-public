...
/**
 * Enforces the effects of Turbolift Complex.
 */
public class EffectsOfScarifTurboLiftComplexRotationRule implements Rule {
     ...
     */
    public EffectsOfScarifTurboLiftComplexRotationRule(ActionsEnvironment actionsEnvironment) {
                ...
                new AbstractActionProxy() {
                    ...
                    public List<TriggerAction> getRequiredAfterTriggers(SwccgGame game, EffectResult effectResult) {
                        ...
                        if (TriggerConditions.isTableChanged(game, effectResult)) {
                            ...
                            for (PhysicalCard location : Filters.filterTopLocationsOnTable(game, Filters.Scarif_Turbolift_Complex)) {
