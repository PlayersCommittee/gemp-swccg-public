...
import com.gempukku.swccgo.logic.timing.results.ExitedStarshipOrVehicleSiteResult;
import com.gempukku.swccgo.logic.timing.results.ExitingStarshipOrVehicleSiteResult;

import java.util.Collection;
import java.util.Collections;

/**
 * An effect to exit a starship/vehicle site to the site the related starship/vehicle is present at.
 */
public class ExitStarshipOrVehicleSiteEffect extends AbstractSubActionEffect implements MovingAsReactEffect {
    ...
    /**
     * Creates an effect to exit a starship/vehicle site to the site the related starship/vehicle is present at.
     ...
     */
    public ExitStarshipOrVehicleSiteEffect(Action action, PhysicalCard cardMoved, PhysicalCard moveTo, boolean asReact) {
        super(action);
        ...
        if (_cardMoved.getAtLocation() != null
            ...
            subAction.appendEffect(
                    new TriggeringResultEffect(subAction,
                            new ExitingStarshipOrVehicleSiteResult(_cardMoved, _playerId, _movedFrom, _movedTo, _asReact)));
            ...
            subAction.appendEffect(
                    new PassthruEffect(subAction) {
                        ...
                        protected void doPlayEffect(SwccgGame game) {
                            ...
                            // Emit effect result
                            game.getActionsEnvironment().emitEffectResult(new ExitedStarshipOrVehicleSiteResult(_cardMoved, _playerId, _movedFrom, _movedTo, _asReact));
                        }
                    }
            );
        }
