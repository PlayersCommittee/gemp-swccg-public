...
/**
 * The effect result that is emitted when a card moves to a starship/vehicle site from a related starship/vehicle.
 */
public class MoveToRelatedStarshipOrVehicleSiteResult extends EffectResult implements MovedResult {
    private PhysicalCard _cardMoved;
    private PhysicalCard _movedFrom;
    private PhysicalCard _movedTo;

    /**
     * Creates an effect result that is emitted when a card moves to a starship/vehicle site from a related starship/vehicle.
     ...
     */
    public MoveToRelatedStarshipOrVehicleSiteResult(PhysicalCard movedCard, String playerId, PhysicalCard moveFrom, PhysicalCard movedTo) {
        super(Type.MOVED_TO_RELATED_STARSHIP_OR_VEHICLE_SITE, playerId);
