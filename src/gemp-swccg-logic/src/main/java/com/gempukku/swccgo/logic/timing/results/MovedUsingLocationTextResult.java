...
/**
 * The effect result that is emitted when a card moves using location text.
 */
public class MovedUsingLocationTextResult extends EffectResult implements MovedResult {
    ...
    /**
     * Creates an effect result that is emitted when a card moves using location text.
     ...
     */
    public MovedUsingLocationTextResult(PhysicalCard movedCard, String playerId, PhysicalCard moveFrom, PhysicalCard movedTo, PhysicalCard locationWithText) {
        super(Type.MOVED_USING_LOCATION_TEXT, playerId);
    ...
    public String getText(SwccgGame game) {
        return "Moved " + GameUtils.getCardLink(_cardMoved) + " from " + GameUtils.getCardLink(_movedFrom) + " to " + GameUtils.getCardLink(_movedTo) + " using " + GameUtils.getCardLink(_locationWithText);
    }
}
