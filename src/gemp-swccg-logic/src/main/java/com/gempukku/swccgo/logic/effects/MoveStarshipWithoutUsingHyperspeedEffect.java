...
import com.gempukku.swccgo.logic.timing.results.MovedWithoutUsingHyperspeedResult;
import com.gempukku.swccgo.logic.timing.results.MovingWithoutUsingHyperspeedResult;

import java.util.Collection;
import java.util.Collections;

/**
 * An effect to move a starship between systems without using hyperspeed.
 */
public class MoveStarshipWithoutUsingHyperspeedEffect extends AbstractSubActionEffect implements MovingAsReactEffect, PreventableCardEffect {
    ...
    private MoveStarshipWithoutUsingHyperspeedEffect _that;

    /**
     * Creates an effect to move a starship between systems without using hyperspeed.
     ...
     */
    public MoveStarshipWithoutUsingHyperspeedEffect(Action action, PhysicalCard cardMoved, PhysicalCard moveTo, boolean asReact, boolean asMoveAway) {
        super(action);
        ...
        if (_cardMoved.getAtLocation() != null
            ...
            subAction.appendEffect(
                    new TriggeringResultEffect(subAction,
                            new MovingWithoutUsingHyperspeedResult(_cardMoved, _playerId, _movedFrom, _movedTo, _asReact, _asMoveAway, _that)));
            ...
            subAction.appendEffect(
                    new PassthruEffect(subAction) {
                        ...
                        protected void doPlayEffect(SwccgGame game) {
                            ...
                            // Emit effect result
                            game.getActionsEnvironment().emitEffectResult(new MovedWithoutUsingHyperspeedResult(_cardMoved, _playerId, _movedFrom, _movedTo, _asReact));
                        }
                    }
            );
        }
