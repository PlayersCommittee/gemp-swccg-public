...
/**
 * An effect to make a character Infected.
 */
public class InfectCharacterEffect extends AbstractSubActionEffect {
    private PhysicalCard _cardDisarmed;
    private PhysicalCard _disarmedByCard;

    /**
     * Creates an effect to make a character Infected.
     * @param action the action performing this effect
     * @param cardDisarmed the card that is Infected
     * @param disarmedByCard the card the card was Infected by
     */
    public InfectCharacterEffect(Action action, PhysicalCard cardDisarmed, PhysicalCard disarmedByCard) {
        super(action);
        ...
        subAction.appendEffect(
                new PassthruEffect(subAction) {
                    ...
                    protected void doPlayEffect(SwccgGame game) {
                        gameState.sendMessage(GameUtils.getCardLink(_cardDisarmed) + " is Infected by " + GameUtils.getCardLink(_disarmedByCard));
