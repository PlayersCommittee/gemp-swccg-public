...
/**
 * The effect result that is emitted when a character or vehicle begins to be shuttled.
 */
public class ShuttlingResult extends EffectResult implements MovingResult {
    private PhysicalCard _cardMoving;
    private PhysicalCard _movingFrom;
    private PhysicalCard _movingTo;

    /**
     * Creates an effect result that is emitted when a character or vehicle begins to be shuttled.
     ...
     */
    public ShuttlingResult(PhysicalCard cardMoving, String playerId, PhysicalCard movingFrom, PhysicalCard movingTo) {
        super(Type.SHUTTLING, playerId);
    ...
    public String getText(SwccgGame game) {
        return "Shuttling " + GameUtils.getCardLink(_cardMoving) + " from " + GameUtils.getCardLink(_movingFrom) + " to " + GameUtils.getCardLink(_movingTo);
    }
}
