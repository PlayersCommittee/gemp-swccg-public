...
/**
 * The effect result that is emitted when a starship or vehicle lands.
 */
public class LandedResult extends EffectResult implements MovedResult {
    ...
    /**
     * Creates an effect result that is emitted when a starship or vehicle lands.
     ...
     */
    public LandedResult(PhysicalCard movedCard, String playerId, PhysicalCard moveFrom, PhysicalCard movedTo, boolean asReact) {
        super(Type.LANDED, playerId);
    ...
    public String getText(SwccgGame game) {
        return "Landed " + GameUtils.getCardLink(_cardMoved) + " from " + GameUtils.getCardLink(_movedFrom) + " to " + GameUtils.getCardLink(_movedTo) + (_asReact ? " as a 'react'" : "");
    }
}
