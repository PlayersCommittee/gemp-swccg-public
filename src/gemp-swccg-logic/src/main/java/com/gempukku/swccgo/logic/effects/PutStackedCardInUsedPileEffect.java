 ...
 */
public class PutStackedCardInUsedPileEffect extends PutStackedCardsInUsedPileEffect {
     ...
     */
    public PutStackedCardInUsedPileEffect(Action action, String playerId, PhysicalCard stackedCard, boolean hidden) {
