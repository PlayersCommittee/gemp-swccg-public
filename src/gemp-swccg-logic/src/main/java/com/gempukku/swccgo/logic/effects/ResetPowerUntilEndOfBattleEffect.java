...
/**
 * An effect to resets the power of a card until end of the battle.
 */
public class ResetPowerUntilEndOfBattleEffect extends AbstractSuccessfulEffect {
    private PhysicalCard _cardToReset;
    private float _resetValue;

    /**
     * Creates an effect that resets the power of a card until end of the battle.
     * @param action the action performing this effect
     * @param cardToReset the card whose power is reset
     * @param resetValue the reset value
     */
    public ResetPowerUntilEndOfBattleEffect(Action action, PhysicalCard cardToReset, float resetValue) {
        super(action);
