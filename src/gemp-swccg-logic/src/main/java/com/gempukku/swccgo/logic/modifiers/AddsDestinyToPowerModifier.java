...
/**
 * A modifier that adds destiny to power during a battle.
 * This is used to when the source card "Adds X destiny to [total] power [only]".
 */
public class AddsDestinyToPowerModifier extends NumDestinyDrawsToPowerOnlyModifier {
    private boolean _skipInBattleCheck;

    /**
     * Creates a modifier that adds destiny to power during a battle.
     * @param source the source of the modifier
     * @param modifierAmount the number of destiny to add
     */
    public AddsDestinyToPowerModifier(PhysicalCard source, int modifierAmount) {
     ...
     */
    public AddsDestinyToPowerModifier(PhysicalCard source, Evaluator evaluator) {
     ...
     * @param source the source of the modifier
     * @param modifierAmount the number of destiny to add
     * @param playerId the player to add destiny to power
     */
    public AddsDestinyToPowerModifier(PhysicalCard source, int modifierAmount, String playerId) {
     ...
     */
    public AddsDestinyToPowerModifier(PhysicalCard source, int modifierAmount, String playerId, boolean skipInBattleCheck) {
     ...
     * @param playerId the player to add destiny to power
     */
    public AddsDestinyToPowerModifier(PhysicalCard source, Evaluator evaluator, String playerId) {
     ...
     * @param modifierAmount the number of destiny to add
     */
    public AddsDestinyToPowerModifier(PhysicalCard source, Condition condition, int modifierAmount) {
     ...
     * @param evaluator the evaluator that calculates the number of destiny to add
     */
    public AddsDestinyToPowerModifier(PhysicalCard source, Condition condition, Evaluator evaluator) {
     ...
     * @param playerId the player to add destiny to power
     */
    public AddsDestinyToPowerModifier(PhysicalCard source, Condition condition, int modifierAmount, String playerId) {
     ...
     * @param skipInBattleCheck true if check for source card in battle is skipped, otherwise false
     */
    public AddsDestinyToPowerModifier(PhysicalCard source, Condition condition, Evaluator evaluator, String playerId, boolean skipInBattleCheck) {
    ...
    public Condition getAdditionalCondition(GameState gameState, ModifiersQuerying modifiersQuerying, PhysicalCard self) {
        ...
        Condition notPreventedCondition = new Condition() {
            ...
            public boolean isFulfilled(GameState gameState, ModifiersQuerying modifiersQuerying) {
                ...
                return !modifiersQuerying.mayNotAddDestinyDrawsToPower(gameState, source.getOwner());
            }
        };
