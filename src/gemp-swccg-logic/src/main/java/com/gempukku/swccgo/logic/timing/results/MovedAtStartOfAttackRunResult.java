...
/**
 * The effect result that is emitted when a starfighter moved at start of an Attack Run.
 */
public class MovedAtStartOfAttackRunResult extends EffectResult implements MovedResult {
    private PhysicalCard _cardMoved;
    private PhysicalCard _movedFrom;
    private PhysicalCard _movedTo;

    /**
     * Creates an effect result that is emitted when a starfighter moved at start of an Attack Run.
     ...
     */
    public MovedAtStartOfAttackRunResult(PhysicalCard movedCard, String playerId, PhysicalCard moveFrom, PhysicalCard movedTo) {
        super(Type.MOVED_AT_START_OF_ATTACK_RUN, playerId);
    ...
    public String getText(SwccgGame game) {
        return "Moved " + GameUtils.getCardLink(_cardMoved) + " from " + GameUtils.getCardLink(_movedFrom) + " into " + GameUtils.getCardLink(_movedFrom) + " at start of an Attack Run";
    }
}
