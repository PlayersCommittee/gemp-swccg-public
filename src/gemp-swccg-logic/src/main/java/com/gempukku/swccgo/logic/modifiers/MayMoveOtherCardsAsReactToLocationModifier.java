 ...
 */
public class MayMoveOtherCardsAsReactToLocationModifier extends AbstractModifier {
     ...
     */
    public MayMoveOtherCardsAsReactToLocationModifier(PhysicalCard source, String actionText, String playerId, Filterable cardFilter, Filterable locationFilter) {
     ...
     * @param locationFilter the location filter
     */
    public MayMoveOtherCardsAsReactToLocationModifier(PhysicalCard source, String actionText, Condition condition, String playerId, Filterable cardFilter, Filterable locationFilter) {
     ...
     */
    public MayMoveOtherCardsAsReactToLocationModifier(PhysicalCard source, String actionText, String playerId, Filterable cardFilter, Filterable locationFilter, float changeInCost) {
