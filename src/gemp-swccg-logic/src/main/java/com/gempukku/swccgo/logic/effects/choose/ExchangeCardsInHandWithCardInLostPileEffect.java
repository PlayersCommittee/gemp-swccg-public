...
public class ExchangeCardsInHandWithCardInLostPileEffect extends ExchangeCardsInHandWithCardInCardPileEffect {
     ...
     * @param maximum  the maximum number of cards from hand to exchange
     */
    public ExchangeCardsInHandWithCardInLostPileEffect(Action action, String playerId, int minimum, int maximum, Filterable cardInPileFilter) {
        super(action, playerId, Zone.LOST_PILE, minimum, maximum, Filters.any, cardInPileFilter, false);
    }
}
