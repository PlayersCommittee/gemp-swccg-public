 ...
 */
public class MayDeployToTargetWithoutPresenceOrForceIconsModifier extends AbstractModifier {
     ...
     */
    public MayDeployToTargetWithoutPresenceOrForceIconsModifier(PhysicalCard source, Filterable targetFilter) {
     ...
     * @param targetFilter the target filter
     */
    public MayDeployToTargetWithoutPresenceOrForceIconsModifier(PhysicalCard source, Filterable affectFilter, Filterable targetFilter) {
     ...
     * @param targetFilter the target filter
     */
    public MayDeployToTargetWithoutPresenceOrForceIconsModifier(PhysicalCard source, Filterable affectFilter, Condition condition, Filterable targetFilter) {
        super(source, null, Filters.and(Filters.not(Filters.in_play), affectFilter), condition, ModifierType.MAY_DEPLOY_WITHOUT_PRESENCE_OR_FORCE_ICONS, true);
        _targetFilter = Filters.and(targetFilter);
    }

    @Override
    public String getText(GameState gameState, ModifiersQuerying modifiersQuerying, PhysicalCard self) {
        return "May deploy to certain targets without presence or Force icons";
    }
