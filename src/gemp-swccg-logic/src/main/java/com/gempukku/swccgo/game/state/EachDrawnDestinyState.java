...
/**
 * This class contains the state information for a single drawn destiny within a draw destiny action.
 */
public class EachDrawnDestinyState {
    private int _id;
    private DrawDestinyEffect _drawDestinyEffect;

    /**
     * Creates state information for a single drawn destiny within a draw destiny action.
     * @param id the unique id
     * @param drawDestinyEffect the draw destiny effect
     */
    public EachDrawnDestinyState(int id, DrawDestinyEffect drawDestinyEffect) {
        _id = id;
