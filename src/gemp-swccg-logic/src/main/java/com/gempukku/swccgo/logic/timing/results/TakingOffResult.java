...
/**
 * The effect result that is emitted when a starship or vehicle begins to take off.
 */
public class TakingOffResult extends EffectResult implements MovingResult {
    ...
    /**
     * Creates an effect result that is emitted when a starship or vehicle begins to take off.
     ...
     */
    public TakingOffResult(PhysicalCard cardMoving, String playerId, PhysicalCard movingFrom, PhysicalCard movingTo, boolean asReact) {
        super(Type.TAKING_OFF, playerId);
    ...
    public String getText(SwccgGame game) {
        return "Taking " + GameUtils.getCardLink(_cardMoving) + " off from " + GameUtils.getCardLink(_movingFrom) + " to " + GameUtils.getCardLink(_movingTo) + (_asReact ? " as a 'react'" : "");
    }
}
