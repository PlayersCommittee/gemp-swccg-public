...
/**
 * The effect result that is emitted when a bomber begins to move to end a Bombing Run.
 */
public class MovingToEndBombingRunResult extends EffectResult implements MovingResult {
    private PhysicalCard _cardMoving;
    private PhysicalCard _movingFrom;
    private PhysicalCard _movingTo;

    /**
     * Creates an effect result that is emitted when a bomber begins to move to end a Bombing Run.
     ...
     */
    public MovingToEndBombingRunResult(PhysicalCard cardMoving, String playerId, PhysicalCard movingFrom, PhysicalCard movingTo) {
        super(Type.MOVING_TO_END_BOMBING_RUN, playerId);
    ...
    public String getText(SwccgGame game) {
        return "Moving " + GameUtils.getCardLink(_cardMoving) + " from " + GameUtils.getCardLink(_movingFrom) + " to " + GameUtils.getCardLink(_movingTo) + " at end of Bombing Run";
    }
}
