...
/**
 * An effect to draw the bottom card into hand from Force Pile.
 */
public class DrawCardIntoHandFromBottomOfForcePileEffect extends DrawCardsIntoHandFromBottomOfForcePileEffect {

    /**
     * Creates an effect that causes the player to draw the bottom card into hand from Force Pile.
     * @param action the action performing this effect
     * @param playerId the player
     */
    public DrawCardIntoHandFromBottomOfForcePileEffect(Action action, String playerId) {
