...
/**
 * The effect result that is emitted when a card exits a starship/vehicle site to the site the related starship/vehicle
 * is present at.
 */
public class ExitedStarshipOrVehicleSiteResult extends EffectResult implements MovedResult {
    ...
    /**
     * Creates an effect result that is emitted when a card exits a starship/vehicle site to the site the related starship/vehicle
     * is present at.
     * @param movedCard the card that moved
     * @param playerId the performing player
     * @param moveFrom the starship/vehicle site the card moved from
     * @param movedTo the site the card moved to
     * @param asReact true if moved as 'react', otherwise false
     */
    public ExitedStarshipOrVehicleSiteResult(PhysicalCard movedCard, String playerId, PhysicalCard moveFrom, PhysicalCard movedTo, boolean asReact) {
        super(Type.EXITED_STARSHIP_OR_VEHICLE_SITE, playerId);
