...
/**
 * The effect result that is emitted when a Mobile Effect moves.
 */
public class MovedMobileEffectResult extends EffectResult implements MovedResult {
    private PhysicalCard _cardMoved;
    private PhysicalCard _movedFrom;
    private PhysicalCard _movedTo;

    /**
     * Creates an effect result that is emitted when a Mobile Effect moves.
     ...
     */
    public MovedMobileEffectResult(PhysicalCard movedCard, String playerId, PhysicalCard moveFrom, PhysicalCard movedTo) {
        super(Type.MOVED_MOBILE_EFFECT, playerId);
