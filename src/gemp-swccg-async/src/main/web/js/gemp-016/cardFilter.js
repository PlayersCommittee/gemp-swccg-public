var CardFilter = Class.extend({
    ...
    buildUi:function (elem, pageElem) {
        ...
        this.iconSelect = $("<select id='iconSelect' class='filterInput'>"
			...
			+ "<option value='CSP'>Clan Scholae Palatinae</option>"
			...
			+ "<option value='DJB_CORE'>Dark Jedi Brotherhood Core</option>"
			+ "<option value='SA'>Shadow Academy</option>"
			+ "<option value='GREAT_HUTT_EXPANSION'>The Great Hutt Expansion</option>"
