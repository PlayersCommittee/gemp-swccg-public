...
/**
 * Click-to-order UI for the rearranging-sites helper. Retract The Bridge and
 * Heart Of The Chasm are not encoded here.
 */
public class RearrangeSitesClickOrderTests {
    ...
    public void ClickSitesInOrderRearrangesAtomicallyAfterAllChosen() {
        ...
        assertTrue(scn.DSDecisionAvailable("Click leftmost site"));
        ...
        assertTrue(scn.DSDecisionAvailable("Click next site from left"));
