...
/**
 * Defines a DB Core booster pack.
 */
public class DBCoreBoosterPack extends BasePackagedCardProduct {
     ...
     */
    public DBCoreBoosterPack(SwccgCardBlueprintLibrary library) {
        super(library);
        RarityReader rarityReader = new RarityReader();
        _setRarity = rarityReader.getSetRarity(String.valueOf(ExpansionSet.DJB_CORE.getSetNumber()));
    }
    ...
    public String getProductName() {
        return ProductName.DB_CORE_BOOSTER_PACK;
    }
    ...
    public float getProductPrice() {
        return ProductPrice.DB_CORE_BOOSTER_PACK;
    }
