...
/**
 * Defines a Special Edition dark starter deck.
 */
public class SpecialEditionDarkStarterDeck extends BasePackagedCardProduct {
    ...
    /**
     * Creates a Special Edition dark starter deck.
     * @param library the blueprint library
     */
    public SpecialEditionDarkStarterDeck(SwccgCardBlueprintLibrary library) {
        super(library);
    ...
    public String getProductName() {
        return ProductName.SPECIAL_EDITION_DARK_STARTER_DECK;
    }
