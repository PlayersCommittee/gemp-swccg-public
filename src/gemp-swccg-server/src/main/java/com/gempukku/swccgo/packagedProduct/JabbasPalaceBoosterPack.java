...
/**
 * Defines a Jabba's Palace booster pack.
 */
public class JabbasPalaceBoosterPack extends BasePackagedCardProduct {
    private Random _random = new Random();
    private SetRarity _setRarity;

    /**
     * Creates a Jabba's Palace booster pack.
     * @param library the blueprint library
     */
    public JabbasPalaceBoosterPack(SwccgCardBlueprintLibrary library) {
        super(library);
        RarityReader rarityReader = new RarityReader();
        _setRarity = rarityReader.getSetRarity(String.valueOf(ExpansionSet.JABBAS_PALACE.getSetNumber()));
    }
    ...
    public String getProductName() {
        return ProductName.JABBAS_PALACE_BOOSTER_PACK;
    }
    ...
    public float getProductPrice() {
        return ProductPrice.JABBAS_PALACE_BOOSTER_PACK;
    }
