...
/**
 * V67bb DEPLOY PHASE SCRIPT (DPS) — ChosenOne mirror of Rando's V67bb.
 * See com.gempukku.swccgo.ai.models.rando.strategy.DeployPhaseScript for full
 * design rationale.
 */
public class DeployPhaseScript {
    ...
    public Result selectAllowedActions(AwaitingDecision decision, GameState gameState,
        ...
        if (classifiedCount == 0) {
            LOG.warn("V67bb DPS NO-OPINION: 0 actions classified — falling through (turn={}, totalActions={})",
                turn, actionIds.length);
            return null;
        }

        // V67bc HIERARCHY: ordered list of step buckets (highest priority first).
        ...
        for (Step step : Step.values()) {
            ...
            if (qualified.isEmpty()) {
                LOG.warn("V67bc DPS step={} qualify-skip (turn={})", step, turn);
                continue;
            }
        ...
        if (orderedBuckets.isEmpty()) {
            LOG.warn("V67bc DPS: classified={} but no step qualified → PASS (turn={})",
    ...
    public static class Result {
        ...
        public final java.util.List<Set<String>> stepBuckets;
        public final java.util.List<String> stepBucketLabels;
        public final Set<String> allowedActionIds;
