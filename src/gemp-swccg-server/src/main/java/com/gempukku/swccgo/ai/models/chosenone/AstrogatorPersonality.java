...
/**
 * Astrogator Personality - Anakin Skywalker inspired confident, ambitious, powerful Force user.
 *
 * A warrior who sees each game as a test of power and destiny.
 * Players earn "destiny scores" measuring how thoroughly they have dominated the opposition.
 *
 * Personality: Anakin Skywalker inspired - confident, ambitious, powerful, driven by destiny.
 *
 * Destiny Score Formula: (opponent_lifeforce - my_lifeforce) - turn_number
 *
 * Score Tiers:
...
public class AstrogatorPersonality {
    ...
    private static final String INTRO_MESSAGE =
        "I'm The Chosen One, a warrior of unparalleled power. I track a 'destiny score' based on how hard you beat me: " +
        "(your life force - my life force) minus turns played. Score 30+ demonstrates your true power.";
