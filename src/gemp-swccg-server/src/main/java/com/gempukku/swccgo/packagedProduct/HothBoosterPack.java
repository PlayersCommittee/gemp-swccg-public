...
/**
 * Defines a Hoth booster pack.
 */
public class HothBoosterPack extends BasePackagedCardProduct {
    private Random _random = new Random();
    private SetRarity _setRarity;

    /**
     * Creates a Hoth booster pack.
     * @param library the blueprint library
     */
    public HothBoosterPack(SwccgCardBlueprintLibrary library) {
        super(library);
        RarityReader rarityReader = new RarityReader();
        _setRarity = rarityReader.getSetRarity(String.valueOf(ExpansionSet.HOTH.getSetNumber()));
    }
    ...
    public String getProductName() {
        return ProductName.HOTH_BOOSTER_PACK;
    }
    ...
    public float getProductPrice() {
        return ProductPrice.HOTH_BOOSTER_PACK;
    }
